...
Rational::Rational(long long numerator, long long denominator)
    : _numerator(denominator > 0 ? numerator : -numerator),
      _denominator(denominator ? (denominator > 0 ? denominator : -denominator)
                               : 1) {
...
Rational operator+(const Rational& r1, const Rational& r2) {
  Rational temp(
      r1._numerator * r2._denominator + r2._numerator * r1._denominator,
...
Rational operator+(long long value, const Rational& r) { return r + value; };
...
Rational operator*(const Rational& r1, const Rational& r2) {
  Rational temp(r1._numerator * r2._numerator,
                r1._denominator * r2._denominator);
  return temp.simplify();
};
...
bool operator>(const Rational& r1, const Rational& r2) {
  ...
  return (r1._numerator * L / r1._denominator >
